...
const createStore = () => {
    const initialState = {
        ...
        sheet: {
            'svw': {
                index: 0,
                minus: { sphCol: 1, sphStartRow: 5, sphEndRow: 29, cylRow: 4, cylStartCol: 2, cylEndCol: 18 },
                plus: { sphCol: 21, sphStartRow: 5, sphEndRow: 28, cylRow: 4, cylStartCol: 22, cylEndCol: 38 }
            },
            'svar': {
                index: 1,
                minus: { sphCol: 1, sphStartRow: 5, sphEndRow: 29, cylRow: 4, cylStartCol: 2, cylEndCol: 18 },
